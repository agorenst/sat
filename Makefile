...
sat: variable.o clause.o cnf.o watched_literals.o preprocess.o lcm.o action.o trail.o clause_learning.o backtrack.o bce.o vsids.o unit_queue.o subsumption.o viv.o plugins.o visualizations.o lbm.o solver.o measurements.o vmtf.o acids.o niver.o
